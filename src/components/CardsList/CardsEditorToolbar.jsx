    ...
    <div className="rounded-xl border border-slate-200 bg-white/50 px-3 py-1.5 shadow-sm">
      <div className="flex w-full flex-col gap-2 overflow-x-auto pb-0.5">
        ...
        <div className="flex min-w-max items-center gap-2">
            ...
            {BRUSH_TYPES.map((item) => {
              ...
              return (
                <button
                  ...
                  title={item.label}
                  className={cn(
                    'inline-flex min-h-[32px] min-w-[56px] flex-col items-center justify-center rounded-lg px-1.5 py-0.5 text-[9px] font-bold transition',
                    active
          ...
          <button
            type="button"
            className="inline-flex h-8 items-center justify-center gap-1.5 rounded-lg bg-white px-2.5 text-[11px] font-semibold text-slate-600 shadow-sm transition hover:-translate-y-0.5 hover:bg-slate-100 hover:text-slate-900"
          ...
          <button
            ...
            disabled={!canAddCard}
            className={cn(
              'inline-flex h-8 shrink-0 items-center gap-1.5 rounded-lg border px-3 text-xs font-bold transition',
              canAddCard
        ...
        <div className="flex w-full min-w-max items-center gap-2">
          ...
          <div className="flex shrink-0 items-center gap-2 rounded-lg border border-slate-100 bg-slate-50/50 px-2 py-1">
            ...
            <input
              ...
              className="color-picker-soft h-5 w-5 cursor-pointer rounded bg-transparent"
            />
          </div>
          ...
          <div className="flex flex-1 items-center gap-2 rounded-lg border border-slate-100 bg-slate-50/50 px-2 py-1">
            ...
            <input
              ...
              className="range-soft w-full min-w-[80px]"
            />
